...
//http://localhost/meutimev1/php/api/FnReturnUserGroups.php/?email=tiagoparadao@hotmail.com&session=xzz&userOID=1
...
if(false)//Coloque em true para montar a URL de testes
{
	...
	$finalURL = "http://localhost/meutimev1/php/api/FnReturnUserGroups.php/" . "?" . http_build_query($URLParameters);
